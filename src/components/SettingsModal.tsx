...
import {
  ACCENT_SWATCHES, AppSettings, DEFAULT_SETTINGS, PanelScales, THEMES,
  installedMonoFonts, installedUiFonts, themeById,
} from "../settings";
...
export default function SettingsModal({ settings, onChange, onClose }: Props) {
  const monoFonts = useMemo(installedMonoFonts, []);
  const uiFonts = useMemo(installedUiFonts, []);
      ...
      <div className="modal settings-modal">
        ...
        <div className="modal-body">
          ...
          <div className="set-section set-cols">
            ...
            <div>
              <div className="set-label">Terminal font</div>
              <select
